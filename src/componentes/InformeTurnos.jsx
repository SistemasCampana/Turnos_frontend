...
export default function Informe() {
    ...
    // ----------------------------------------------------
    return (
        // 🚨 MODIFICACIÓN CLAVE: Las clases de centrado (max-w-6xl mx-auto) se fusionan con el contenedor principal
        // para asegurar que el centrado funcione correctamente.
        <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-8 max-w-6xl mx-auto">
